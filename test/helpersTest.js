...
describe('findUser', function() {
  it('should return the userID of a valid email, password pair, with an error_id of zero', function() {
    ...
    const user = findUser("user3@example.com", "star", testUsers)
  ...
  it('should return a message indication wrong password, with an message_id of 2', function() {
    const user = findUser("user3@example.com", "star2", testUsers)
  ...
  it('should return a message indication wrong email, with an message_id of 1', function() {
    const user = findUser("use@example.com", "star2", testUsers)
...
describe('userURLs', function() {
  it('should return the url that is tied to the user_id', function() {
  ...
  it('should return an empty object when presented with a invalid user_id', function() {
